...
ren %REPLACED_DIR%\Bars\DEV\BAR_%APPLICATION_NAME%.bar %REPLACED_DIR%\Bars\DEV\BAR_%APPLICATION_NAME%.zip
powershell Expand-Archive -Path %REPLACED_DIR%\Bars\DEV\BAR_%APPLICATION_NAME%.zip -DestinationPath %REPLACED_DIR%\Bars\TempBar
ren %REPLACED_DIR%\Bars\TempBar\%APPLICATION_NAME%.appzip %REPLACED_DIR%\Bars\TempBar\%APPLICATION_NAME%.zip
...
ren %REPLACED_DIR%\Bars\TempBar\%APPLICATION_NAME%.zip %REPLACED_DIR%\Bars\TempBar\%APPLICATION_NAME%.appzip
...
ren %REPLACED_DIR%\Bars\TempBar\BAR_%APPLICATION_NAME%.zip %REPLACED_DIR%\Bars\DEV\BAR_%APPLICATION_NAME%.bar
